/**
 * The kitchen-equipment checklist (VISION §5, DESIGN_BRIEF §5 «Профиль
 * кухни»): our own starting profile is oven, microwave, kettle, induction
 ...
 * user strings side by side (VISION §5: «чеклист + свободный ввод») — the
 * presets are only the subset the UI renders as checkboxes; anything else
 * typed into «Добавить своё» lands in the same array untouched.
 */
